...
namespace coursework1 {
    ...
    public partial class courseworkDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/courseworkDataSet7.xsd";
        ...
        public partial class clientsDataTable : global::System.Data.TypedTableBase<clientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public clientsRow AddclientsRow(int id, string name, string address, string phone, string email, System.DateTime birthdate) {
...
namespace coursework1.courseworkDataSetTableAdapters {
    ...
    public partial class clientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[clients] WHERE (([id] = @Original_id) AND ((@IsNull_birthdate " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[clients] ([id], [name], [address], [phone], [email], [birthdat" +
                "e]) VALUES (@id, @name, @address, @phone, @email, @birthdate);\r\nSELECT id, name," +
                " address, phone, email, birthdate FROM clients WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[clients] SET [id] = @id, [name] = @name, [address] = @address, [phone] = @phone, [email] = @email, [birthdate] = @birthdate WHERE (([id] = @Original_id) AND ((@IsNull_birthdate = 1 AND [birthdate] IS NULL) OR ([birthdate] = @Original_birthdate)));
SELECT id, name, address, phone, email, birthdate FROM clients WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, address, phone, email, birthdate FROM dbo.clients";
        ...
        public virtual int Insert(int id, string name, string address, string phone, string email, global::System.Nullable<global::System.DateTime> birthdate) {
        ...
        public virtual int Update(int id, string name, string address, string phone, string email, global::System.Nullable<global::System.DateTime> birthdate, int Original_id, global::System.Nullable<global::System.DateTime> Original_birthdate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string address, string phone, string email, global::System.Nullable<global::System.DateTime> birthdate, int Original_id, global::System.Nullable<global::System.DateTime> Original_birthdate) {
            return this.Update(Original_id, name, address, phone, email, birthdate, Original_id, Original_birthdate);
        }
    }
